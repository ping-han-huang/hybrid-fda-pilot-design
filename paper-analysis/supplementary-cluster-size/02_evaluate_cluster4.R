# Evaluate the cluster-size-4 FPCA estimates under exhaustive and PSS search.
...
fpca_estimates <- load_rdata_object(
  "paper-analysis/intermediate/supplementary-cluster-size/fpca_cluster4.Rdata",
  "fpca_estimates"
)
...
output_file <- "paper-analysis/intermediate/supplementary-cluster-size/evaluation_cluster4.Rdata"
