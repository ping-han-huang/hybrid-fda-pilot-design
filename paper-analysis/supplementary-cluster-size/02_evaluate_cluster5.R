# Evaluate the cluster-size-5 FPCA estimates under exhaustive and PSS search.
...
fpca_estimates <- load_rdata_object(
  "paper-analysis/intermediate/supplementary-cluster-size/fpca_cluster5.Rdata",
  "fpca_estimates"
)
...
output_file <- "paper-analysis/intermediate/supplementary-cluster-size/evaluation_cluster5.Rdata"
