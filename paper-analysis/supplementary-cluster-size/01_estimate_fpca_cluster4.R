# Estimate FPCA from the supplied sparse pilot datasets for cluster size 4.
...
pilot_data <- load_rdata_object(
  "paper-analysis/data/supplementary-cluster-size/pilotFourierHybrid4.Rdata",
  "pilot_hybridDesign"
)
...
output_file <- "paper-analysis/intermediate/supplementary-cluster-size/fpca_cluster4.Rdata"
