# Estimate FPCA from the supplied sparse pilot datasets for cluster size 5.
...
pilot_data <- load_rdata_object(
  "paper-analysis/data/supplementary-cluster-size/pilotFourierHybrid5.Rdata",
  "pilot_hybridDesign"
)
...
output_file <- "paper-analysis/intermediate/supplementary-cluster-size/fpca_cluster5.Rdata"
