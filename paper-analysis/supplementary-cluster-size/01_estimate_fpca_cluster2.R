# Estimate FPCA from the supplied sparse pilot datasets for cluster size 2.
...
pilot_data <- load_rdata_object(
  "paper-analysis/data/supplementary-cluster-size/pilotFourierHybrid2.Rdata",
  "pilot_hybridDesign"
)
...
output_file <- "paper-analysis/intermediate/supplementary-cluster-size/fpca_cluster2.Rdata"
