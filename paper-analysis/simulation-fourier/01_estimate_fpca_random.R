...
pilot_data <- load_rdata_object("paper-analysis/data/simulation-fourier/pilotFourierRandom.Rdata", "pilot_randomDesign")
...
output_file <- "paper-analysis/intermediate/simulation-fourier/fpca_random.Rdata"
