...
pilot_data <- load_rdata_object("paper-analysis/data/simulation-fourier/pilotFourierHybrid.Rdata", "pilot_hybridDesign")
...
output_file <- "paper-analysis/intermediate/simulation-fourier/fpca_hybrid.Rdata"
