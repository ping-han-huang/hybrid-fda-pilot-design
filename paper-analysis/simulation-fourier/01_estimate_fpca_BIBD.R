...
pilot_data <- load_rdata_object("paper-analysis/data/simulation-fourier/pilotFourierBIBD.Rdata", "pilot_bibDesign")
...
output_file <- "paper-analysis/intermediate/simulation-fourier/fpca_BIBD.Rdata"
