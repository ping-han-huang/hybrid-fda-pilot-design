...
pilot_data <- load_rdata_object("paper-analysis/data/case-study-medfly/pilotMedrealBIBD.Rdata", "pilot_bibDesign")
...
output_file <- "paper-analysis/intermediate/case-study-medfly/fpca_BIBD.Rdata"
