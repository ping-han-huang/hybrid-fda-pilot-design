...
pilot_data <- load_rdata_object("paper-analysis/data/case-study-medfly/pilotMedrealHybrid.Rdata", "pilot_hybridDesign")
...
output_file <- "paper-analysis/intermediate/case-study-medfly/fpca_hybrid.Rdata"
